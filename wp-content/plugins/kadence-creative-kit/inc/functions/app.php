...
use KadenceWP\CreativeKit\Container;
use KadenceWP\CreativeKit\Core;
use KadenceWP\CreativeKit\lucatume\DI52\Container as DI52Container;
 ...
 * @return Core
 */
function kadence_creative_kit_plugin(): Core {
	...
	return Core::instance( realpath( __DIR__ . '/../../kadence-creative-kit.php' ), $container );
}
 ...
 * @return void
 */
function kadence_creative_kit_log( $data ): void {
