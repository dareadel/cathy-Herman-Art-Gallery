...
namespace KadenceWP\CreativeKit;

use InvalidArgumentException;
use RuntimeException;
use KadenceWP\CreativeKit\StellarWP\ContainerContract\ContainerInterface;
...
class Core {
	...
	public const PLUGIN_FILE         = 'kadence_creative_kit.plugin_file';
	...
	private function __construct(
		...
		$this->container->singleton( \KadenceWP\CreativeKit\Psr\Container\ContainerInterface::class, $this->container );
		$this->container->singleton( KadenceWP\CreativeKit\Psr\Container\ContainerInterface::class, $this->container );
