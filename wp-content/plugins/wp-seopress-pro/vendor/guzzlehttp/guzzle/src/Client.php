...
namespace SEOPressPro\Vendor\GuzzleHttp;

use SEOPressPro\Vendor\GuzzleHttp\Cookie\CookieJar;
use SEOPressPro\Vendor\GuzzleHttp\Cookie\CookieJarInterface;
use SEOPressPro\Vendor\GuzzleHttp\Exception\GuzzleException;
use SEOPressPro\Vendor\GuzzleHttp\Exception\InvalidArgumentException;
use SEOPressPro\Vendor\GuzzleHttp\Handler\CurlShareHandleState;
use SEOPressPro\Vendor\GuzzleHttp\Handler\CurlVersion;
 ...
 * @final
 */
class Client implements ClientInterface, \SEOPressPro\Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
