...
namespace SEOPressPro\Vendor\GuzzleHttp\Exception;

use SEOPressPro\Vendor\GuzzleHttp\BodySummarizer;
use SEOPressPro\Vendor\GuzzleHttp\BodySummarizerInterface;
use SEOPressPro\Vendor\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \SEOPressPro\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
