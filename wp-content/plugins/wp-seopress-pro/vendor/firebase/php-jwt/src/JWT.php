...
namespace SEOPressPro\Vendor\Firebase\JWT;
...
class JWT
{
    ...
    public static function sign(string $msg, $key, string $alg): string
    {
        ...
        switch ($function) {
            ...
            case 'openssl':
                ...
                return $signature;
            case 'sodium_crypto':
                if (!\function_exists('sodium_crypto_sign_detached') && !\function_exists('SEOPressPro\Vendor\sodium_crypto_sign_detached')) {
    ...
    private static function verify(string $msg, string $signature, $keyMaterial, string $alg): bool
    {
        ...
        switch ($function) {
            ...
            case 'sodium_crypto':
                if (!\function_exists('sodium_crypto_sign_verify_detached') && !\function_exists('SEOPressPro\Vendor\sodium_crypto_sign_verify_detached')) {
                    throw new DomainException('libsodium is not available');
                }
