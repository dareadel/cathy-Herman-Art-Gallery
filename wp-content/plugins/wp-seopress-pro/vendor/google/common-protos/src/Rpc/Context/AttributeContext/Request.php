...
namespace SEOPressPro\Vendor\Google\Rpc\Context\AttributeContext;
 ...
 */
class Request extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkMapField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::STRING, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::STRING);
        $this->headers = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Rpc\Context\AttributeContext\Auth::class);
        $this->auth = $var;
        return $this;
    }
}
