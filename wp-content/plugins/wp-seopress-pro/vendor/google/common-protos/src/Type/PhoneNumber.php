 ...
 */
class PhoneNumber extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Type\PhoneNumber::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Type\PhoneNumber\ShortCode::class);
