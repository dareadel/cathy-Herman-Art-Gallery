...
namespace SEOPressPro\Vendor\Google\Type;
 ...
 */
class DateTime extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Type\Datetime::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Type\TimeZone::class);
