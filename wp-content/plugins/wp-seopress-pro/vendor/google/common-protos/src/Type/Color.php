 ...
 */
class Color extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Type\Color::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Protobuf\FloatValue::class);
        $this->alpha = $var;
        return $this;
    }
    /**
