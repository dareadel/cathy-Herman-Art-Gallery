 ...
 */
class AuditConfigDelta extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Cloud\Iam\V1\AuditConfigDelta\Action::class);
        $this->action = $var;
        return $this;
    }
    /**
