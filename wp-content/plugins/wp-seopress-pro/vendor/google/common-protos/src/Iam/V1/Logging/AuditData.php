...
namespace SEOPressPro\Vendor\Google\Iam\V1\Logging;
 ...
 */
class AuditData extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Iam\V1\Logging\AuditData::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Cloud\Iam\V1\PolicyDelta::class);
