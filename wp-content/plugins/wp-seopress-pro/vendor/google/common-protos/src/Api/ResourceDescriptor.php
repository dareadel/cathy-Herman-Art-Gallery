 ...
 */
class ResourceDescriptor extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Api\ResourceDescriptor\History::class);
        $this->history = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::ENUM, \SEOPressPro\Vendor\Google\Api\ResourceDescriptor\Style::class);
        $this->style = $arr;
        return $this;
    }
}
