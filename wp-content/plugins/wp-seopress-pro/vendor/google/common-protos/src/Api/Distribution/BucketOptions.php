...
namespace SEOPressPro\Vendor\Google\Api\Distribution;
 ...
 */
class BucketOptions extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    protected $options;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\Distribution\BucketOptions\Linear::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\Distribution\BucketOptions\Exponential::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\Distribution\BucketOptions\Explicit::class);
