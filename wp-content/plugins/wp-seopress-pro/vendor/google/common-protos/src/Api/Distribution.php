 ...
 */
class Distribution extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Api\Distribution::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\Distribution\Range::class);
        $this->range = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\Distribution\BucketOptions::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::INT64);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Api\Distribution\Exemplar::class);
        $this->exemplars = $arr;
        return $this;
    }
}
