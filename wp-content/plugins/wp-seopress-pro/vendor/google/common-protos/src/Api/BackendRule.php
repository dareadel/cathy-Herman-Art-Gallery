 ...
 */
class BackendRule extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Api\BackendRule\PathTranslation::class);
    ...
    {
        $arr = GPBUtil::checkMapField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::STRING, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Api\BackendRule::class);
