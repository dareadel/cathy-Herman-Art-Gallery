 ...
 */
class MetricDescriptor extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Api\LabelDescriptor::class);
        $this->labels = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Api\MetricDescriptor\MetricKind::class);
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Api\MetricDescriptor\ValueType::class);
        $this->value_type = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Api\MetricDescriptor\MetricDescriptorMetadata::class);
        $this->metadata = $var;
        return $this;
    }
    /**
