 ...
 */
class ConfigChange extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\Google\Api\ConfigChange::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Api\ChangeType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Api\Advice::class);
        $this->advices = $arr;
        return $this;
    }
}
