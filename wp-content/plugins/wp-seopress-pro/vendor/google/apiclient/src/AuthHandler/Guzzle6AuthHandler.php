...
namespace SEOPressPro\Vendor\Google\AuthHandler;
...
use SEOPressPro\Vendor\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use SEOPressPro\Vendor\Google\Auth\Middleware\SimpleMiddleware;
