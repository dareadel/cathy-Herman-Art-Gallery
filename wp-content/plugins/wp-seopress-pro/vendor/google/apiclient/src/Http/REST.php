 ...
 */
namespace SEOPressPro\Vendor\Google\Http;

use SEOPressPro\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use SEOPressPro\Vendor\Google\Service\Exception as GoogleServiceException;
use SEOPressPro\Vendor\Google\Task\Runner;
use SEOPressPro\Vendor\GuzzleHttp\ClientInterface;
use SEOPressPro\Vendor\GuzzleHttp\Exception\RequestException;
use SEOPressPro\Vendor\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (interface_exists('SEOPressPro\Vendor\GuzzleHttp\Message\ResponseInterface') && $response instanceof \SEOPressPro\Vendor\GuzzleHttp\Message\ResponseInterface) {
