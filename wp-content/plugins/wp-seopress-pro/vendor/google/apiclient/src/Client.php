 ...
 */
namespace SEOPressPro\Vendor\Google;

use BadMethodCallException;
use DomainException;
use SEOPressPro\Vendor\Google\AccessToken\Revoke;
use SEOPressPro\Vendor\Google\AccessToken\Verify;
use SEOPressPro\Vendor\Google\Auth\ApplicationDefaultCredentials;
use SEOPressPro\Vendor\Google\Auth\Cache\MemoryCacheItemPool;
use SEOPressPro\Vendor\Google\Auth\Credentials\ServiceAccountCredentials;
use SEOPressPro\Vendor\Google\Auth\Credentials\UserRefreshCredentials;
use SEOPressPro\Vendor\Google\Auth\CredentialsLoader;
use SEOPressPro\Vendor\Google\Auth\FetchAuthTokenCache;
use SEOPressPro\Vendor\Google\Auth\GetUniverseDomainInterface;
use SEOPressPro\Vendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use SEOPressPro\Vendor\Google\Auth\OAuth2;
use SEOPressPro\Vendor\Google\AuthHandler\AuthHandlerFactory;
use SEOPressPro\Vendor\Google\Http\REST;
use SEOPressPro\Vendor\GuzzleHttp\Client as GuzzleClient;
use SEOPressPro\Vendor\GuzzleHttp\ClientInterface;
use SEOPressPro\Vendor\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use SEOPressPro\Vendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use SEOPressPro\Vendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use SEOPressPro\Vendor\Monolog\Logger;
use SEOPressPro\Vendor\Psr\Cache\CacheItemPoolInterface;
use SEOPressPro\Vendor\Psr\Http\Message\RequestInterface;
use SEOPressPro\Vendor\Psr\Http\Message\ResponseInterface;
use SEOPressPro\Vendor\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (defined('SEOPressPro\Vendor\GuzzleHttp\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (defined('SEOPressPro\Vendor\GuzzleHttp\ClientInterface::VERSION')) {
