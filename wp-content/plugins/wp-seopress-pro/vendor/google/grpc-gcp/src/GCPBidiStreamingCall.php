...
class GCPBidiStreamingCall extends GcpBaseCall
{
    ...
    protected function createRealCall($data = null)
    {
        ...
        $this->real_call = new \SEOPressPro\Vendor\Grpc\BidiStreamingCall($channel_ref->getRealChannel($this->gcp_channel->credentials), $this->method, $this->deserialize, $this->options);
