 ...
 *
 */
namespace SEOPressPro\Vendor\Grpc\Gcp;
...
class GCPClientStreamCall extends GcpBaseCall
{
    protected function createRealCall($data = null)
    {
        ...
        $this->real_call = new \SEOPressPro\Vendor\Grpc\ClientStreamingCall($channel_ref->getRealChannel($this->gcp_channel->credentials), $this->method, $this->deserialize, $this->options);
