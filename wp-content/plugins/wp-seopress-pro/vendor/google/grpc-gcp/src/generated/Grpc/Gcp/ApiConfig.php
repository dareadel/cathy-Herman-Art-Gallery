 ...
 */
class ApiConfig extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \SEOPressPro\Vendor\GPBMetadata\GrpcGcp::initOnce();
        parent::__construct();
    }
    /**
     * The channel pool configurations.
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Grpc\Gcp\ChannelPoolConfig::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Grpc\Gcp\MethodConfig::class);
        $this->method = $arr;
        return $this;
    }
}
