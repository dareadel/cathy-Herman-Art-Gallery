 ...
 */
class AffinityConfig extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
        return $this;
    }
    /**
