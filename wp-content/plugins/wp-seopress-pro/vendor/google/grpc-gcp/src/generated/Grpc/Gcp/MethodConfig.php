 ...
 */
class MethodConfig extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Grpc\Gcp\AffinityConfig::class);
        $this->affinity = $var;
        return $this;
    }
}
