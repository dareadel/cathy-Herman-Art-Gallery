 ...
 *
 * Generated from protobuf message <code>google.analytics.data.v1alpha.CreateRecurringAudienceListRequest</code>
 */
class CreateRecurringAudienceListRequest extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     *
     * Generated from protobuf field <code>.google.analytics.data.v1alpha.RecurringAudienceList recurring_audience_list = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
     ...
     * @experimental
     */
    public static function build(string $parent, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\RecurringAudienceList $recurringAudienceList): self
    {
        return (new self())->setParent($parent)->setRecurringAudienceList($recurringAudienceList);
    }
    /**
     * Constructor.
     *
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\RecurringAudienceList::class);
