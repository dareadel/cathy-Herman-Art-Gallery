 ...
 */
class CreateAudienceListRequest extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $parent, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\AudienceList $audienceList): self
    {
        return (new self())->setParent($parent)->setAudienceList($audienceList);
    }
    /**
     * Constructor.
     *
