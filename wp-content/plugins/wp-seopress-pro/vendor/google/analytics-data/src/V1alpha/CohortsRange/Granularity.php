...
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\CohortsRange;
...
class Granularity
{
     ...
     */
    const MONTHLY = 3;
    private static $valueToName = [self::GRANULARITY_UNSPECIFIED => 'GRANULARITY_UNSPECIFIED', self::DAILY => 'DAILY', self::WEEKLY => 'WEEKLY', self::MONTHLY => 'MONTHLY'];
