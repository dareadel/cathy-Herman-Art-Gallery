...
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\OrderBy\PivotOrderBy;
 ...
 *     ---------|----------|----------------|----------|----------------
 *
 * Generated from protobuf message <code>google.analytics.data.v1alpha.OrderBy.PivotOrderBy.PivotSelection</code>
 */
class PivotSelection extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
