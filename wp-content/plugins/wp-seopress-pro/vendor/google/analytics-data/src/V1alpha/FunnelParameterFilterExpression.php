 ...
 */
class FunnelParameterFilterExpression extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    protected $expr;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelParameterFilterExpressionList::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelParameterFilter::class);
