...
class EventExclusionDuration
{
    ...
    private static $valueToName = [self::EVENT_EXCLUSION_DURATION_UNSPECIFIED => 'EVENT_EXCLUSION_DURATION_UNSPECIFIED', self::EVENT_EXCLUSION_PERMANENT => 'EVENT_EXCLUSION_PERMANENT'];
