 ...
 */
class FilterExpression extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    protected $expr;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FilterExpressionList::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\Filter::class);
