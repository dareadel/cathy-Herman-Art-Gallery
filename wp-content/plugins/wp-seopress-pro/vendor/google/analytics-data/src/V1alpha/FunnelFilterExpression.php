 ...
 */
class FunnelFilterExpression extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    protected $expr;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelFilterExpressionList::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelFilterExpression::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelFieldFilter::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\FunnelEventFilter::class);
