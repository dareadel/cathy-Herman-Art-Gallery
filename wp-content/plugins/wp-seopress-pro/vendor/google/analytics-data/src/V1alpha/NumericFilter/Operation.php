...
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\NumericFilter;

use UnexpectedValueException;
/**
 * The operation applied to a numeric filter
 *
 * Protobuf type <code>google.analytics.data.v1alpha.NumericFilter.Operation</code>
 */
class Operation
{
    /**
    ...
    private static $valueToName = [self::OPERATION_UNSPECIFIED => 'OPERATION_UNSPECIFIED', self::EQUAL => 'EQUAL', self::LESS_THAN => 'LESS_THAN', self::LESS_THAN_OR_EQUAL => 'LESS_THAN_OR_EQUAL', self::GREATER_THAN => 'GREATER_THAN', self::GREATER_THAN_OR_EQUAL => 'GREATER_THAN_OR_EQUAL'];
