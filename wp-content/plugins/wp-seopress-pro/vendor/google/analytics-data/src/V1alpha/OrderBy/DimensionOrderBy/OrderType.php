...
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\OrderBy\DimensionOrderBy;

use UnexpectedValueException;
/**
 * Rule to order the string dimension values by.
 *
 * Protobuf type <code>google.analytics.data.v1alpha.OrderBy.DimensionOrderBy.OrderType</code>
 */
class OrderType
{
    /**
