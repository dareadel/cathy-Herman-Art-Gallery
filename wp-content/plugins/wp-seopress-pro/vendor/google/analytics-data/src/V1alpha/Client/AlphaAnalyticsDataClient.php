 ...
 * @experimental
 */
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\Client;
...
final class AlphaAnalyticsDataClient
{
    ...
    {
        return self::getPathTemplate('audienceList')->render(['property' => $property, 'audience_list' => $audienceList]);
    }
    /**
    ...
    {
        return self::getPathTemplate('recurringAudienceList')->render(['property' => $property, 'recurring_audience_list' => $recurringAudienceList]);
    }
    /**
