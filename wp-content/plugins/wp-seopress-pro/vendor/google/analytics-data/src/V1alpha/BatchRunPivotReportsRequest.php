...
class BatchRunPivotReportsRequest extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\RunPivotReportRequest::class);
        $this->requests = $arr;
        return $this;
    }
}
