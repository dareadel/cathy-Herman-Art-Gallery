 ...
 */
class DimensionExpression extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\DimensionExpression\CaseExpression::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\DimensionExpression\ConcatenateExpression::class);
