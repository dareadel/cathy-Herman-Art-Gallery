 ...
 */
class OrderBy extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\OrderBy\MetricOrderBy::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\OrderBy\DimensionOrderBy::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1alpha\OrderBy\PivotOrderBy::class);
