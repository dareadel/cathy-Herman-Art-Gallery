 ...
 */
class CreateAudienceExportRequest extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
     ...
     * @experimental
     */
    public static function build(string $parent, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\AudienceExport $audienceExport): self
    {
