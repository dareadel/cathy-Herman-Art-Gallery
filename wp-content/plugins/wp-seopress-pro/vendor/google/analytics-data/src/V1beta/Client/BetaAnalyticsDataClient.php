 ...
 * @experimental
 */
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1beta\Client;
...
use SEOPressPro\Vendor\Google\ApiCore\ResourceHelperTrait;
...
final class BetaAnalyticsDataClient
{
    ...
    {
        return self::getPathTemplate('audienceExport')->render(['property' => $property, 'audience_export' => $audienceExport]);
    }
    /**
    ...
    {
        return self::getPathTemplate('metadata')->render(['property' => $property]);
    }
    /**
    ...
    {
        return self::getPathTemplate('property')->render(['property' => $property]);
    }
    /**
