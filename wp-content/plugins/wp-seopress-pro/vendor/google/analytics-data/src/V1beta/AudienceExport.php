 ...
 */
class AudienceExport extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\AudienceDimension::class);
        $this->dimensions = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\AudienceExport\State::class);
        $this->state = $var;
        return $this;
    }
    /**
