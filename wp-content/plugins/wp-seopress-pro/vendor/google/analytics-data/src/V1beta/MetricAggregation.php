 ...
 *
 * Protobuf type <code>google.analytics.data.v1beta.MetricAggregation</code>
 */
class MetricAggregation
{
     ...
     */
    const COUNT = 4;
    private static $valueToName = [self::METRIC_AGGREGATION_UNSPECIFIED => 'METRIC_AGGREGATION_UNSPECIFIED', self::TOTAL => 'TOTAL', self::MINIMUM => 'MINIMUM', self::MAXIMUM => 'MAXIMUM', self::COUNT => 'COUNT'];
