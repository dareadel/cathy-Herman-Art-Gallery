...
namespace SEOPressPro\Vendor\Google\Analytics\Data\V1beta\MetricMetadata;
...
class BlockedReason
{
    ...
    private static $valueToName = [self::BLOCKED_REASON_UNSPECIFIED => 'BLOCKED_REASON_UNSPECIFIED', self::NO_REVENUE_METRICS => 'NO_REVENUE_METRICS', self::NO_COST_METRICS => 'NO_COST_METRICS'];
