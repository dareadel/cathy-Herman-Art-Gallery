...
class ResponseMetaData extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\ResponseMetaData\SchemaRestrictionResponse::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\SamplingMetadata::class);
