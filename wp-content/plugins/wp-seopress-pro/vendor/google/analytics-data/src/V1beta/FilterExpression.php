...
class FilterExpression extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\FilterExpressionList::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\Filter::class);
