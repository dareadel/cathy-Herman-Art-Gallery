...
class OrderBy extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\OrderBy\MetricOrderBy::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\OrderBy\DimensionOrderBy::class);
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Analytics\Data\V1beta\OrderBy\PivotOrderBy::class);
