...
use SEOPressPro\Vendor\Google\Auth\Credentials\ExternalAccountCredentials;
use SEOPressPro\Vendor\Google\Auth\Credentials\ImpersonatedServiceAccountCredentials;
use SEOPressPro\Vendor\Google\Auth\Credentials\InsecureCredentials;
...
abstract class CredentialsLoader implements GetUniverseDomainInterface, FetchAuthTokenInterface, UpdateMetadataInterface
{
    ...
    public static function makeHttpClient(FetchAuthTokenInterface $fetcher, array $httpClientOptions = [], callable $httpHandler = null, callable $tokenCallback = null)
    {
        ...
        $stack = \SEOPressPro\Vendor\GuzzleHttp\HandlerStack::create();
        $stack->push($middleware);
        return new \SEOPressPro\Vendor\GuzzleHttp\Client(['handler' => $stack, 'auth' => 'google_auth'] + $httpClientOptions);
    }
    /**
