 ...
 */
use SEOPressPro\Vendor\google\appengine\api\app_identity\AppIdentityService;
...
class AppIdentityCredentials extends CredentialsLoader implements SignBlobInterface, ProjectIdProviderInterface
{
    ...
    {
        if (!self::onAppEngine() || !class_exists('SEOPressPro\Vendor\google\appengine\api\app_identity\AppIdentityService')) {
