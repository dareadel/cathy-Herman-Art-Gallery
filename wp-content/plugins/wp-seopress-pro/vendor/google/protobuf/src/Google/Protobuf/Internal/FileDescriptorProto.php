 ...
 */
class FileDescriptorProto extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::INT32);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Protobuf\Internal\ServiceDescriptorProto::class);
        $this->service = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\FileOptions::class);
        $this->options = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\SourceCodeInfo::class);
