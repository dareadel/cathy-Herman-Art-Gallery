...
use SEOPressPro\Vendor\Google\Protobuf\Internal\CodedInputStream;
use SEOPressPro\Vendor\Google\Protobuf\Internal\CodedOutputStream;
use SEOPressPro\Vendor\Google\Protobuf\Internal\DescriptorPool;
use SEOPressPro\Vendor\Google\Protobuf\Internal\GPBLabel;
use SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType;
use SEOPressPro\Vendor\Google\Protobuf\Internal\GPBWire;
use SEOPressPro\Vendor\Google\Protobuf\Internal\MapEntry;
use SEOPressPro\Vendor\Google\Protobuf\Internal\RepeatedField;
use SEOPressPro\Vendor\Google\Protobuf\ListValue;
use SEOPressPro\Vendor\Google\Protobuf\Value;
use SEOPressPro\Vendor\Google\Protobuf\Struct;
use SEOPressPro\Vendor\Google\Protobuf\NullValue;
/**
...
class Message
{
    ...
    private function initWithGeneratedPool()
    {
        ...
        foreach ($this->desc->getField() as $field) {
            ...
            } else if ($field->getLabel() === GPBLabel::OPTIONAL && \PHP_INT_SIZE == 4) {
                switch ($field->getType()) {
                    case GPBType::INT64:
                    case GPBType::UINT64:
    ...
    private function convertJsonValueToProtoValue($value, $field, $ignore_unknown, $is_map_key = \false)
    {
        switch ($field->getType()) {
            case GPBType::MESSAGE:
                $klass = $field->getMessageType()->getClass();
                $submsg = new $klass();
                if (is_a($submsg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Duration")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                ...
                } else if (is_a($submsg, "SEOPressPro\\Vendor\\Google\\Protobuf\\FieldMask")) {
                    if (is_null($value)) {
                        return $this->defaultValue($field);
                    }
                    try {
                    ...
                    if (is_null($value) && !is_a($submsg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Value")) {
                        return $this->defaultValue($field);
                    }
    ...
    {
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Any")) {
            $this->clear();
        ...
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\DoubleValue") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\FloatValue") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Int64Value") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\UInt64Value") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Int32Value") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\UInt32Value") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\BoolValue") || is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\StringValue")) {
            $this->setValue($array);
            return;
        }
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\BytesValue")) {
            $this->setValue(base64_decode($array));
            return;
        }
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Duration")) {
            $this->mergeFrom(GPBUtil::parseDuration($array));
            return;
        }
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\FieldMask")) {
            $this->mergeFrom(GPBUtil::parseFieldMask($array));
            return;
        }
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Timestamp")) {
            $this->mergeFrom(GPBUtil::parseTimestamp($array));
            return;
        }
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Struct")) {
        ...
        if (is_a($this, "SEOPressPro\\Vendor\\Google\\Protobuf\\Value")) {
            if (is_bool($array)) {
    ...
    public function parseFromJsonStream($input, $ignore_unknown)
    {
        ...
        if ($this instanceof \SEOPressPro\Vendor\Google\Protobuf\ListValue) {
            $array = ["values" => $array];
        }
        if (is_null($array)) {
            if ($this instanceof \SEOPressPro\Vendor\Google\Protobuf\Value) {
                $this->setNullValue(\SEOPressPro\Vendor\Google\Protobuf\NullValue::NULL_VALUE);
                return;
            } else {
    ...
    public function serializeToJsonStream(&$output)
    {
        if (is_a($this, 'SEOPressPro\Vendor\Google\Protobuf\Any')) {
            ...
            $output->writeRaw("}", 1);
        } elseif (is_a($this, 'SEOPressPro\Vendor\Google\Protobuf\FieldMask')) {
            $field_mask = GPBUtil::formatFieldMask($this);
            $output->writeRaw("\"", 1);
            $output->writeRaw($field_mask, strlen($field_mask));
            $output->writeRaw("\"", 1);
        } elseif (is_a($this, 'SEOPressPro\Vendor\Google\Protobuf\Duration')) {
            ...
            if (!$this->existField($field)) {
                $output->writeRaw("[]", 2);
            } else if (!$this->serializeFieldToJsonStream($output, $field)) {
                return \false;
            }
