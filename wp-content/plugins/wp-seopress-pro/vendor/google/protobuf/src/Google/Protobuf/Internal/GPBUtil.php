...
use SEOPressPro\Vendor\Google\Protobuf\Duration;
use SEOPressPro\Vendor\Google\Protobuf\FieldMask;
use SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType;
use SEOPressPro\Vendor\Google\Protobuf\Internal\RepeatedField;
use SEOPressPro\Vendor\Google\Protobuf\Internal\MapField;
use function bccomp;
...
class GPBUtil
{
    ...
    public static function checkInt64(&$var)
    {
        if (is_numeric($var)) {
            if (\PHP_INT_SIZE == 8) {
                $var = intval($var);
            } else if (is_float($var) || is_integer($var) || is_string($var) && bccomp($var, "9223372036854774784") < 0) {
    ...
    public static function parseTimestamp($timestamp)
    {
        ...
        $value = new \SEOPressPro\Vendor\Google\Protobuf\Timestamp();
    ...
    {
        return is_a($msg, 'SEOPressPro\Vendor\Google\Protobuf\Any') || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\ListValue") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Struct") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Value") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Duration") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Timestamp") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\FieldMask") || static::hasJsonValue($msg);
    }
    public static function hasJsonValue($msg)
    {
        return is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\DoubleValue") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\FloatValue") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Int64Value") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\UInt64Value") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\Int32Value") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\UInt32Value") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\BoolValue") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\StringValue") || is_a($msg, "SEOPressPro\\Vendor\\Google\\Protobuf\\BytesValue");
    }
}
