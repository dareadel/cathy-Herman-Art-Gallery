 ...
 */
class MethodOptions extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\MethodOptions\IdempotencyLevel::class);
