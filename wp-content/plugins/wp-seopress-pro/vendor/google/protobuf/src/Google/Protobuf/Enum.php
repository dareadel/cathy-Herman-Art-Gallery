 ...
 */
class Enum extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
     * Enum type name.
     *
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\GPBType::MESSAGE, \SEOPressPro\Vendor\Google\Protobuf\EnumValue::class);
        $this->enumvalue = $arr;
        return $this;
    }
    /**
