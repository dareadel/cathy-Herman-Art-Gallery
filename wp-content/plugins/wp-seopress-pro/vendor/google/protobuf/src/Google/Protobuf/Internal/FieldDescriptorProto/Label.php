...
namespace SEOPressPro\Vendor\Google\Protobuf\Internal\FieldDescriptorProto;
...
class Label
{
    ...
    private static $valueToName = [self::LABEL_OPTIONAL => 'LABEL_OPTIONAL', self::LABEL_REQUIRED => 'LABEL_REQUIRED', self::LABEL_REPEATED => 'LABEL_REPEATED'];
...
class_alias(Label::class, \SEOPressPro\Vendor\Google\Protobuf\Internal\FieldDescriptorProto_Label::class);
