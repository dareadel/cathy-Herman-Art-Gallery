 ...
 */
class FileOptions extends \SEOPressPro\Vendor\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \SEOPressPro\Vendor\Google\Protobuf\Internal\FileOptions\OptimizeMode::class);
