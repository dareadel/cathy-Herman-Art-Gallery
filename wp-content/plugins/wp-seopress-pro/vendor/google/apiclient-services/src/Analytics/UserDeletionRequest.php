...
class UserDeletionRequest extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var string
     */
...
class_alias(UserDeletionRequest::class, 'SEOPressPro\Vendor\Google_Service_Analytics_UserDeletionRequest');
