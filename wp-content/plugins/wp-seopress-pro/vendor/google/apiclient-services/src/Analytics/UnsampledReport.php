...
class UnsampledReport extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(UnsampledReport::class, 'SEOPressPro\Vendor\Google_Service_Analytics_UnsampledReport');
