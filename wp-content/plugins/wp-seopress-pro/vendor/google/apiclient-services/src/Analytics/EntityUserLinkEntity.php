...
class EntityUserLinkEntity extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(EntityUserLinkEntity::class, 'SEOPressPro\Vendor\Google_Service_Analytics_EntityUserLinkEntity');
