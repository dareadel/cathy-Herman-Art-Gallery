 ...
 *  </code>
 */
class ManagementAccountUserLinks extends \SEOPressPro\Vendor\Google\Service\Resource
{
    /**
...
class_alias(ManagementAccountUserLinks::class, 'SEOPressPro\Vendor\Google_Service_Analytics_Resource_ManagementAccountUserLinks');
