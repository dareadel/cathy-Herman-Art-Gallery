 ...
 * the License.
 */
namespace SEOPressPro\Vendor\Google\Service\Analytics\Resource;

use SEOPressPro\Vendor\Google\Service\Analytics\AnalyticsDataimportDeleteUploadDataRequest;
use SEOPressPro\Vendor\Google\Service\Analytics\Upload;
use SEOPressPro\Vendor\Google\Service\Analytics\Uploads;
/**
 ...
 *  </code>
 */
class ManagementUploads extends \SEOPressPro\Vendor\Google\Service\Resource
{
    /**
...
class_alias(ManagementUploads::class, 'SEOPressPro\Vendor\Google_Service_Analytics_Resource_ManagementUploads');
