...
class AccountSummary extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(AccountSummary::class, 'SEOPressPro\Vendor\Google_Service_Analytics_AccountSummary');
