...
class ProfileFilterLink extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(ProfileFilterLink::class, 'SEOPressPro\Vendor\Google_Service_Analytics_ProfileFilterLink');
