...
class IncludeConditions extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var int
     */
...
class_alias(IncludeConditions::class, 'SEOPressPro\Vendor\Google_Service_Analytics_IncludeConditions');
