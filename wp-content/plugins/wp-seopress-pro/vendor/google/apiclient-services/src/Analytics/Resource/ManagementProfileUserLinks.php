 ...
 *  </code>
 */
class ManagementProfileUserLinks extends \SEOPressPro\Vendor\Google\Service\Resource
{
    /**
...
class_alias(ManagementProfileUserLinks::class, 'SEOPressPro\Vendor\Google_Service_Analytics_Resource_ManagementProfileUserLinks');
