...
class RemarketingAudience extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(RemarketingAudience::class, 'SEOPressPro\Vendor\Google_Service_Analytics_RemarketingAudience');
