...
class GaDataDataTable extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(GaDataDataTable::class, 'SEOPressPro\Vendor\Google_Service_Analytics_GaDataDataTable');
