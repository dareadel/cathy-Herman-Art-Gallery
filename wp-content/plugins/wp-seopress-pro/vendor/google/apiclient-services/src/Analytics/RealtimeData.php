...
class RealtimeData extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(RealtimeData::class, 'SEOPressPro\Vendor\Google_Service_Analytics_RealtimeData');
