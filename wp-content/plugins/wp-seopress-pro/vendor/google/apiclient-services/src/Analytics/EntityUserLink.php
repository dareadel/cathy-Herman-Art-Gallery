...
class EntityUserLink extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(EntityUserLink::class, 'SEOPressPro\Vendor\Google_Service_Analytics_EntityUserLink');
