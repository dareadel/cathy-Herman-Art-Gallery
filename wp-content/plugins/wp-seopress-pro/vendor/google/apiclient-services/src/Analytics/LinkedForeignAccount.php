...
class LinkedForeignAccount extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var string
     */
...
class_alias(LinkedForeignAccount::class, 'SEOPressPro\Vendor\Google_Service_Analytics_LinkedForeignAccount');
