...
class GoalEventDetails extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(GoalEventDetails::class, 'SEOPressPro\Vendor\Google_Service_Analytics_GoalEventDetails');
