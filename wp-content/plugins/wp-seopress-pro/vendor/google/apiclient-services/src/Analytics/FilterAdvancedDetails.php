...
class FilterAdvancedDetails extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
class_alias(FilterAdvancedDetails::class, 'SEOPressPro\Vendor\Google_Service_Analytics_FilterAdvancedDetails');
