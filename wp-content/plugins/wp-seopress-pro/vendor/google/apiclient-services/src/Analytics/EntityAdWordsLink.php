...
class EntityAdWordsLink extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(EntityAdWordsLink::class, 'SEOPressPro\Vendor\Google_Service_Analytics_EntityAdWordsLink');
