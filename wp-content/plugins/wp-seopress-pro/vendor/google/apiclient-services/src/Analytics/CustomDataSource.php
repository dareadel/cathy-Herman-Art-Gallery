...
class CustomDataSource extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(CustomDataSource::class, 'SEOPressPro\Vendor\Google_Service_Analytics_CustomDataSource');
