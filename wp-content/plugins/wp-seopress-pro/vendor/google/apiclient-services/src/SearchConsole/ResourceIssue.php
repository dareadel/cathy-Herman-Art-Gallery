...
class ResourceIssue extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(ResourceIssue::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_ResourceIssue');
