...
class SearchAnalyticsQueryResponse extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(SearchAnalyticsQueryResponse::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_SearchAnalyticsQueryResponse');
