...
class IndexStatusInspectionResult extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(IndexStatusInspectionResult::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_IndexStatusInspectionResult');
