...
class RunMobileFriendlyTestResponse extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(RunMobileFriendlyTestResponse::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_RunMobileFriendlyTestResponse');
