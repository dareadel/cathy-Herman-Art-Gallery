...
class SearchAnalyticsQueryRequest extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(SearchAnalyticsQueryRequest::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_SearchAnalyticsQueryRequest');
