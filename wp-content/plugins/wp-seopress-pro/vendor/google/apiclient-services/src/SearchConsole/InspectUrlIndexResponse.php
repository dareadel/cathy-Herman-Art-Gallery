...
class InspectUrlIndexResponse extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(InspectUrlIndexResponse::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_InspectUrlIndexResponse');
