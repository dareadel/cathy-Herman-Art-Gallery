...
class AmpInspectionResult extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(AmpInspectionResult::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_AmpInspectionResult');
