...
class UrlInspectionResult extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(UrlInspectionResult::class, 'SEOPressPro\Vendor\Google_Service_SearchConsole_UrlInspectionResult');
