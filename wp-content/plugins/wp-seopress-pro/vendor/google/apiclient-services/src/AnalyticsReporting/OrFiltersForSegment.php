...
class OrFiltersForSegment extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(OrFiltersForSegment::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_OrFiltersForSegment');
