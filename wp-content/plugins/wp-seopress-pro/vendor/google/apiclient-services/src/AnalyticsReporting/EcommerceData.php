...
class EcommerceData extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(EcommerceData::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_EcommerceData');
