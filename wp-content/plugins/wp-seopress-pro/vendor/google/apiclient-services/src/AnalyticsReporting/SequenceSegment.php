...
class SequenceSegment extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(SequenceSegment::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_SequenceSegment');
