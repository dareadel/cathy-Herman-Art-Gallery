...
class DynamicSegment extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var string
     */
...
class_alias(DynamicSegment::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_DynamicSegment');
