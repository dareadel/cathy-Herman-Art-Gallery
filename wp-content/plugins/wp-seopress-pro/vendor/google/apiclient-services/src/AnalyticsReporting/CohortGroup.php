...
class CohortGroup extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(CohortGroup::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_CohortGroup');
