...
class PivotHeaderEntry extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(PivotHeaderEntry::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_PivotHeaderEntry');
