...
class TransactionData extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var string
     */
...
class_alias(TransactionData::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_TransactionData');
