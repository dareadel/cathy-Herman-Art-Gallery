...
class MetricHeader extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(MetricHeader::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_MetricHeader');
