...
class SimpleSegment extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(SimpleSegment::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_SimpleSegment');
