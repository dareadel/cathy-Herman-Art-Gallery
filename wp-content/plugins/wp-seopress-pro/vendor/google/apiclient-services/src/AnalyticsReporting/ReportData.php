...
class ReportData extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(ReportData::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_ReportData');
