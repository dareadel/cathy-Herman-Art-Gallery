...
class GetReportsRequest extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(GetReportsRequest::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_GetReportsRequest');
