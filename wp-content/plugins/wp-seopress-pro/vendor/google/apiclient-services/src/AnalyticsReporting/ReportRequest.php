...
class ReportRequest extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(ReportRequest::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_ReportRequest');
