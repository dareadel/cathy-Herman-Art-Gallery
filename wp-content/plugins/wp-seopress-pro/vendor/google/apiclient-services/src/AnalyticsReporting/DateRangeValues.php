...
class DateRangeValues extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(DateRangeValues::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_DateRangeValues');
