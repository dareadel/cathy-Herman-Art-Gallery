...
class SegmentFilter extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var bool
     */
...
class_alias(SegmentFilter::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_SegmentFilter');
