...
class PivotHeader extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(PivotHeader::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_PivotHeader');
