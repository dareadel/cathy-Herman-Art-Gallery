...
class ScreenviewData extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var string
     */
...
class_alias(ScreenviewData::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_ScreenviewData');
