...
class SegmentSequenceStep extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(SegmentSequenceStep::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_SegmentSequenceStep');
