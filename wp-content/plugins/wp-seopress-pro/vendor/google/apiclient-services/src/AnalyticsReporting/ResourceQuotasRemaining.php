...
class ResourceQuotasRemaining extends \SEOPressPro\Vendor\Google\Model
{
    /**
     * @var int
     */
...
class_alias(ResourceQuotasRemaining::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_ResourceQuotasRemaining');
