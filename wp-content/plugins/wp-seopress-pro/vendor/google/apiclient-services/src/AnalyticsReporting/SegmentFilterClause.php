...
class SegmentFilterClause extends \SEOPressPro\Vendor\Google\Model
{
...
class_alias(SegmentFilterClause::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_SegmentFilterClause');
