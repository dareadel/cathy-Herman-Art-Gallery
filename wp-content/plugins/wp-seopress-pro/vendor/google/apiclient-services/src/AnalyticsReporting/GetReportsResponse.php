...
class GetReportsResponse extends \SEOPressPro\Vendor\Google\Collection
{
...
class_alias(GetReportsResponse::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting_GetReportsResponse');
