 ...
 * @author Google, Inc.
 */
class AnalyticsReporting extends \SEOPressPro\Vendor\Google\Service
{
...
class_alias(AnalyticsReporting::class, 'SEOPressPro\Vendor\Google_Service_AnalyticsReporting');
