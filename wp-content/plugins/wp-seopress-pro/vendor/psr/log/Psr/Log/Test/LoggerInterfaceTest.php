...
namespace SEOPressPro\Vendor\Psr\Log\Test;

use SEOPressPro\Vendor\Psr\Log\LoggerInterface;
use SEOPressPro\Vendor\Psr\Log\LogLevel;
use SEOPressPro\Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('SEOPressPro\Vendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('SEOPressPro\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('SEOPressPro\Vendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
