...
abstract class Random
{
    ...
    public static function string($length)
    {
        ...
        if ($crypto === \false) {
            ...
            switch (\true) {
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\AES'):
                    $crypto = new AES('ctr');
                    break;
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\Twofish'):
                    $crypto = new Twofish('ctr');
                    break;
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\Blowfish'):
                    $crypto = new Blowfish('ctr');
                    break;
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\TripleDES'):
                    $crypto = new TripleDES('ctr');
                    break;
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\DES'):
                    $crypto = new DES('ctr');
                    break;
                case class_exists('SEOPressPro\Vendor\phpseclib3\Crypt\RC4'):
                    $crypto = new RC4();
                    break;
                default:
