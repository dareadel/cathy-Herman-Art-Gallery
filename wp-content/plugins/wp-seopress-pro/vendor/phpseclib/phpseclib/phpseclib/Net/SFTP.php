...
use SEOPressPro\Vendor\phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (!defined('SEOPressPro\Vendor\NET_SFTP_QUEUE_SIZE')) {
            define('SEOPressPro\Vendor\NET_SFTP_QUEUE_SIZE', 32);
        }
        if (!defined('SEOPressPro\Vendor\NET_SFTP_UPLOAD_QUEUE_SIZE')) {
            define('SEOPressPro\Vendor\NET_SFTP_UPLOAD_QUEUE_SIZE', 1024);
        }
    }
    /**
    ...
    private function send_sftp_packet($type, $data, $request_id = 1)
    {
        ...
        $stop = microtime(\true);
        if (defined('SEOPressPro\Vendor\NET_SFTP_LOGGING')) {
