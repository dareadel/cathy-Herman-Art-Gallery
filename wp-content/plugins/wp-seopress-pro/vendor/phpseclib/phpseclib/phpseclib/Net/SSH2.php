 ...
 */
namespace SEOPressPro\Vendor\phpseclib3\Net;

use SEOPressPro\Vendor\phpseclib3\Common\Functions\Strings;
use SEOPressPro\Vendor\phpseclib3\Crypt\Blowfish;
use SEOPressPro\Vendor\phpseclib3\Crypt\ChaCha20;
use SEOPressPro\Vendor\phpseclib3\Crypt\Common\AsymmetricKey;
use SEOPressPro\Vendor\phpseclib3\Crypt\Common\PrivateKey;
use SEOPressPro\Vendor\phpseclib3\Crypt\Common\PublicKey;
use SEOPressPro\Vendor\phpseclib3\Crypt\Common\SymmetricKey;
use SEOPressPro\Vendor\phpseclib3\Crypt\DH;
use SEOPressPro\Vendor\phpseclib3\Crypt\DSA;
use SEOPressPro\Vendor\phpseclib3\Crypt\EC;
use SEOPressPro\Vendor\phpseclib3\Crypt\Hash;
use SEOPressPro\Vendor\phpseclib3\Crypt\Random;
use SEOPressPro\Vendor\phpseclib3\Crypt\RC4;
use SEOPressPro\Vendor\phpseclib3\Crypt\Rijndael;
use SEOPressPro\Vendor\phpseclib3\Crypt\RSA;
use SEOPressPro\Vendor\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use SEOPressPro\Vendor\phpseclib3\Crypt\Twofish;
use SEOPressPro\Vendor\phpseclib3\Exception\ConnectionClosedException;
use SEOPressPro\Vendor\phpseclib3\Exception\InsufficientSetupException;
use SEOPressPro\Vendor\phpseclib3\Exception\InvalidPacketLengthException;
use SEOPressPro\Vendor\phpseclib3\Exception\NoSupportedAlgorithmsException;
use SEOPressPro\Vendor\phpseclib3\Exception\TimeoutException;
use SEOPressPro\Vendor\phpseclib3\Exception\UnableToConnectException;
use SEOPressPro\Vendor\phpseclib3\Exception\UnsupportedAlgorithmException;
use SEOPressPro\Vendor\phpseclib3\Exception\UnsupportedCurveException;
use SEOPressPro\Vendor\phpseclib3\Math\BigInteger;
use SEOPressPro\Vendor\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        if (!is_resource($this->fsock)) {
            ...
            if (defined('SEOPressPro\Vendor\NET_SSH2_LOGGING')) {
    ...
    {
        if (defined('SEOPressPro\Vendor\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
