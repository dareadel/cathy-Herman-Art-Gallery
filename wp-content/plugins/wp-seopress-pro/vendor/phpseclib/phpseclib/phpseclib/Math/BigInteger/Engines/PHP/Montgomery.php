 ...
 */
namespace SEOPressPro\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;

use SEOPressPro\Vendor\phpseclib3\Math\BigInteger\Engines\Engine;
use SEOPressPro\Vendor\phpseclib3\Math\BigInteger\Engines\PHP;
use SEOPressPro\Vendor\phpseclib3\Math\BigInteger\Engines\PHP\Reductions\PowerOfTwo;
/**
 * PHP Montgomery Modular Exponentiation Engine
 *
 * @author  Jim Wigginton <terrafrost@php.net>
