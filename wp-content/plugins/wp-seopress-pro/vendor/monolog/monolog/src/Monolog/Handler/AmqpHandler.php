...
use SEOPressPro\Vendor\Monolog\Formatter\JsonFormatter;
use SEOPressPro\Vendor\PhpAmqpLib\Message\AMQPMessage;
use SEOPressPro\Vendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
