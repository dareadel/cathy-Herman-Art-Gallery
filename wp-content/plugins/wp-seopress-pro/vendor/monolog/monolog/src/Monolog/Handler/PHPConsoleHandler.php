...
use SEOPressPro\Vendor\Monolog\Formatter\LineFormatter;
use SEOPressPro\Vendor\Monolog\Formatter\FormatterInterface;
use SEOPressPro\Vendor\Monolog\Logger;
use SEOPressPro\Vendor\Monolog\Utils;
use SEOPressPro\Vendor\PhpConsole\Connector;
use SEOPressPro\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use SEOPressPro\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('SEOPressPro\Vendor\PhpConsole\Connector')) {
