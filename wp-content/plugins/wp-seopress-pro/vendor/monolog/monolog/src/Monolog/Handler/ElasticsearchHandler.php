...
use SEOPressPro\Vendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use SEOPressPro\Vendor\Monolog\Logger;
use SEOPressPro\Vendor\Monolog\Formatter\FormatterInterface;
use SEOPressPro\Vendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use SEOPressPro\Vendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use SEOPressPro\Vendor\Elasticsearch\Client;
use SEOPressPro\Vendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use SEOPressPro\Vendor\Elastic\Elasticsearch\Client as Client8;
/**
