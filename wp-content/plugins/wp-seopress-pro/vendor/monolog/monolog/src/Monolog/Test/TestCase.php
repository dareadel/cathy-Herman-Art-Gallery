 ...
 */
namespace SEOPressPro\Vendor\Monolog\Test;

use SEOPressPro\Vendor\Monolog\Logger;
use SEOPressPro\Vendor\Monolog\DateTimeImmutable;
 ...
 */
class TestCase extends \SEOPressPro\Vendor\PHPUnit\Framework\TestCase
{
