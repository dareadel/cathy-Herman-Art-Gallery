 ...
 */
namespace SEOPressPro\Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = array_map('SEOPressPro\Vendor\Monolog\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
