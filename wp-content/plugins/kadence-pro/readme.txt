...
Kadence Theme Pro plugin through the Patchstack
Vulnerability Disclosure Program https://patchstack.com/database/vdp/kadence-pro The
...
Kadence Theme Pro plugin's source code through the
Patchstack Vulnerability Disclosure
Program https://patchstack.com/database/vdp/kadence-pro. The Patchstack team will
assist you with verification, CVE assignment, and notify the
developers of this plugin.

== Changelog ==

== 1.2.5 | 5th August 2026 ==
* Tweak: Improved the unified licensing page experience.
* Fix: Maintenance mode not applying to WooCommerce product pages.

== 1.2.4 | 11th June 2026 ==
* Tweak: Improved the Kadence add-ons update flow for legacy licenses.
* Fix: Dark mode not applying to global palette colors 10-15.

== 1.2.3 | 27th May 2026 ==
* Fix: Mini cart not opening or refreshing when adding products to cart on WooCommerce 10.6+ (block-based Mini Cart).
...
* Tweak - The Settings -> Liquid Web Products page now requires an opt-in to communicate with external servers.

== 1.2.0 | 11th May 2026 ==
* Feature - Integrate with Nexcess Licensing and Portal.

== 1.1.19 | 26th February 2026 ==
* Fix: List elements not visible inside the mega menu

== 1.1.18 | 25th February 2026 ==
* Fix: Gallery(Adv) carousel not working inside Ultimate Menu custom content (via Elements)

== 1.1.17 | 11th February 2026 ==
* Fix: Infinite Scroll Pagination Breaks After Clicking the Back Button

== 1.1.16 | 6th November 2025 ==
* Add: Support for Kadence Theme secondary button styles

== 1.1.15 | August 28th 2025 ==
* Add: Shortcut to create new Elements from some admin bar menus

== 1.1.14 | 23rd July 2025 ==
* Fix: Style for sticky add to cart prices.
* Fix: Full width mega menu overflow.

== 1.1.13 | 19th June 2025 ==
* Add: admin bar menu that displays active Elements on pages.
* Add: Description for some settings in customizer.

== 1.1.12 | 5th June 2025 ==
* Update: Adding Mega Menu open on click/hover settings to Secondary+ navigations.

== 1.1.11 | 15th May 2025 ==
* Fix: Local Gravatars option affecting the Discussion setting avatars

== 1.1.10 | 1st May 2025 ==
* Fix: List items can sometimes disappear in mega menu when Customizer on click is active

== 1.1.9 | 7th April 2025 ==
* Update: WPML meta support with Kadence Elements
* Update: Allow for license embeds.

== 1.1.8 | 13th March 2025 ==
* Add: Ability to import & export Kadence Elements
* Fix: Issue with activation notice
* Fix: Improve support for click to open menu option in Kadence theme.

== 1.1.7 | 14th February 2025 ==
* Fix: Incorrect parsing when placing elements within content.

== 1.1.6 | 12th February 2025 ==
* Add: Notice in admin bar when a maintenance mode page is potentially active.

== 1.1.5 | 5th February 2025 ==
* Fix: Issue with some mega menu styles affecting Kadence navigation blocks

== 1.1.4 | 4th February 2025 ==
* Fix: Issue with woocommerce subscription switch (upgrade) variations and ajax add to cart.
* Fix: Issue with Single Product AJAX option and multi-select in PPOM plugin
* Fix: PolyLang translations for conditional header button labels
* Fix: Conditional Header Display Settings not offering Author options on Single Pages
* Fix: Navigation Block "Collapse Vertical Sub Menus" issue when inside a mega menu
* Fix: Google PageSpeed warning in Account Header widget
* Fix: Maintenance Mode page background color is not resetting.
* Fix: Conversion item visible when Maintenance Mode active
* Fix: _load_textdomain_just_in_time warning message

== 1.1.3 | 5th December 2024 ==
* Fix: Issue with light dark color switch for text (adv) blocks
* Fix: Conflict with woocommerce off canvas sidebar and header block
* Fix: Issue with display and font sizes in Maintenance Mode pages
* Fix: Issue with Maintenance Mode and SEO plugins
* Fix: Issue with Maintenance Mode showing Kadence Conversion elements
* Fix: Maintenance Mode undefined variable warning

== 1.1.2 | 18th November 2024 ==
* Add: Elements that replace password protected single post content now show the password form before the element.
* Fix: Issue with Element Fixed positioning

== 1.1.1 | 15th November 2024 ==
* Fix: Issue with maintenance mode and the customizer

== 1.1.0 | 14th November 2024 ==
* Add: Maintenance Mode and Coming Soon Pages

== 1.0.22 | 30th October 2024 ==
* Fix: Issue with Elementor Pro 3.25 breaking rendering function.

== 1.0.21 | 4th October 2024 ==
* Add: Option to set a custom box shadow.
* Update: Element previews when using query builder.
* Update: Tweak css for element titles.
* Fix: Issue with some full width mega menus causing overflow.

== 1.0.20 | 5th February 2024 ==
* Update: Added additional validation elements.
* Fix: PHP 8.2+ compatibility.

== 1.0.19 | 11th January 2024 ==
* Update: Updater to update via ajax.

== 1.0.18 | 3rd January 2024 ==
* Fix: Possible issue with event tickets.
* Fix: Possible issue with notice cache.

== 1.0.17 | 22nd December 2023 ==
* Update: license key connect for ithemes licenses.

== 1.0.16 | 20th December 2023 ==
* Update: Key input obfuscate.

== 1.0.15 | 18th December 2023 ==
...
== 1.0.14 | 26th September 2023 ==
* Add: Variable for active elements.
* Fix: Improper label on WooCommerce "After Checkout Form" option.
* Fix: Missing mobile account layout options.

== 1.0.13 | 14th August 2023 ==
